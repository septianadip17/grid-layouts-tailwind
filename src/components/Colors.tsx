const Colors = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-2 gap-y-3 grid-flow-row-dense">
      ...
      <div className="bg-yellow-500 rounded-lg shadow-xl min-h-[50px] row-span-2" />
